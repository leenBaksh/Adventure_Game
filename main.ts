 ...
 do {
   let ask = await inquirer.prompt([
     {
       ...
       choices: ["Attack", "Drink Blood", "Run for your life..."],
     },
   ]);
   ...
   if (ask.opt == "Attack") {
     ...
     if (num > 0) {
       ...
       if (o1.fuel <= 0) {
         console.log(chalk.magenta("Congratulations you win!"));
         process.exit();
       }
     }
     ...
     P1.fuelIncrease();
     console.log(
       chalk.red(`You drank a health potion. Your fuel is ${P1.fuel}`)
     );
   } else if (ask.opt == "Run for your life...") {
     console.log(chalk.redBright("You lose Game, Better luck next time.."));
     process.exit();
   }
 } while (true);